...
class FlutterBluetoothPrinterScreen extends StatefulWidget {
  const FlutterBluetoothPrinterScreen({Key? key}) : super(key: key);

  @override
  State<FlutterBluetoothPrinterScreen> createState() =>
      _FlutterBluetoothPrinterScreenState();
}

class _FlutterBluetoothPrinterScreenState
    extends State<FlutterBluetoothPrinterScreen> {
              ...
              if (selected == null) {
                showDialog<String>(
                  ...
                  builder: (BuildContext context) => AlertDialog(
                    ...
                    content: const Text('Please Check Bluetooth Device'),
                    actions: <Widget>[
                      TextButton(
